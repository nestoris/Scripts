...
function rne_pf(rn,u1,u2,u5,u40,u200,u500,u1000,u2000){
#u1 1,21,31,101
...
return (unit==1&&(ten!=1||length(rn)==1))?u1:(u2&&unit<5&&unit>1&&ten!=1?u2:(u40&&(ten0==40||ten0==90||hun==100)?u40:(u200&&(hun==200||hun==300||hun==400)?u200:(u1000&&ten0==0?(thu==1000&&tthu!=1?u1000:(u2000&&thu<=4000&&thu>=2000?u2000:(unit==0?(!pmil&&mil>0?"":u500):u5))):u5))))#())))))
#" unit=" unit " hun=" hun " ten0=" ten0 " pmil=" pmil " mil=" mil
...
out_rne=(unit==1&&(ten!=1||length(rn)==1))?raz:(dva&&unit<5&&unit>1&&ten!=1?dva:(nol&&rn==0?nol:mnogo))
