#!/usr/bin/awk -f
function rne(rusnum,raz,dva,mnogo,nol){ # Russian Number Endings (rusnum=number; raz -- ending for 1, 21, 101, etc; dva -- 2-4, 22-24, 102-104...; mnogo -- 0, 5-20, 25-30, 95-100...)
